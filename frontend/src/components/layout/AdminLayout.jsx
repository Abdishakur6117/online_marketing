    ...
    <div>
      ...
      {open && (
        <div className="ml-4 space-y-1">
          <NavItem to="/admin/report/marketer" label="Marketer Report" />
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-[250px_1fr] bg-gray-100">
      ...
      >
        ...
        <NavItem to="/admin/campaigns" label="Campaigns" />
        <NavItem to="/admin/orders" label="List Orders" />
        <ReportDropdown />
      </aside>
      ...
      <div className="flex flex-col">
        ...
        <footer className="bg-white text-center py-2 text-sm border-t">
          &copy; {new Date().getFullYear()} Online Marketing Platform — Admin
        </footer>
      </div>
    </div>
  );
